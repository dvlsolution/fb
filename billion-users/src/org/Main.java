...
public class Main {
    ...
    /*
        ...
        These apps will all be launched at the same time and no user ever uses more than one of the apps. We want to know how many
    ...
    int getBillionUsersDay(float[] growthRates) {
        ...
        double target = 1_000_000_000.0;
        int start = 1;
        // considering this to be the upper limit, but it's not explicitly defined
        // we can add a loop and increase upper limit if target not reached, like 2k, 4k, 6k etc
        // total complexity will be O(k log n), where k is number of iterations
        int end = 2000;
